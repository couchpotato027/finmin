  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      ...
      try {
        ...
        const candleData = pricesData.map(p => {
        ...
        chart.subscribeCrosshairMove((param) => {
            ...
            if (data) {
                ...
                tooltipRef.current.innerHTML = `
                    ...
                    <div class="flex justify-between items-center mb-1"><span class="text-gray-400 text-xs text-left">Open:</span> <span class="font-mono text-white text-[13px] font-medium text-right">${curSymbol}${data.open.toFixed(2)}</span></div>
                    <div class="flex justify-between items-center mb-1"><span class="text-gray-400 text-xs text-left">High:</span> <span class="font-mono text-[#10b981] text-[13px] font-medium text-right">${curSymbol}${data.high.toFixed(2)}</span></div>
                    <div class="flex justify-between items-center mb-1"><span class="text-gray-400 text-xs text-left">Low:</span> <span class="font-mono text-[#ef4444] text-[13px] font-medium text-right">${curSymbol}${data.low.toFixed(2)}</span></div>
                    <div class="flex justify-between items-center mb-2"><span class="text-gray-400 text-xs text-left">Close:</span> <span class="font-mono text-white text-[13px] font-bold text-right">${curSymbol}${data.close.toFixed(2)}</span></div>
  ...
  return (
    <div className="flex flex-col w-full h-full relative">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-lg font-semibold text-white">Price Action & Volume</h2>
